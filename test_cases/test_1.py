...
class TestMainPage(BaseTest):
    ...
    def test_budapest_route2(self):
        ...
        longest_route = self.main_page2.get_longest_route(routes)
        print(longest_route)

        self.main_page2.select_route(longest_route[0])

        details_page = self.main_page2.open_details_of_routes(longest_route[0])
        route_info = details_page.get_route_info()
        print(route_info)
